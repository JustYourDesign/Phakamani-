...
const FACE =
  "inline-flex h-14 shrink-0 items-center gap-2 whitespace-nowrap rounded-xl px-6 text-sm font-semibold tracking-wide text-forest/40";

const HIT =
  "outline-none transition-colors duration-150 hover:text-forest focus-visible:bg-accent focus-visible:text-forest focus-visible:shadow-[inset_0_0_0_1px_var(--primary)]";
...
export function LogoMarquee({
  ...
  return (
    <section
      aria-label={label}
      className={`relative isolate w-full min-w-0 max-w-full overflow-hidden rounded-2xl border border-border bg-card ${className}`}
      {...bind}
    >
      <div
        ref={viewportRef}
